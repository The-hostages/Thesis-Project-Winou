...
export default class Map extends React.Component {
    ...
    mergeCoords = async () => {
      ...
      const hasStartAndEnd = positionState.latitude !== null && desLatitude !== null
    ...
    render() {
      ...
      let { positionState, markerPosition, coords, loadingMap,coordsTrain } = this.state;
      console.log("position state on render ", positionState.latitude);
      return (
        <View style={Styles.container}>
        {loadingMap &&
        <MapView  style={Styles.map} initialRegion={positionState} showsUserLocation >
          {this.renderMarkers()}
          <MapView.Polyline
            strokeWidth={4}
